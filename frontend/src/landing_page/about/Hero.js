...
function Hero() {
    return (
        <div className="container">
            ...
            <div className="row p-5 mt-5 border-top text-muted" style={{ lineHeight: "1.8", lineWidth: "100%", fontSize: "1.2em" }}>
                ...
                <div className="col-6 p-5">
                    ...
                    <p>
                        <span className="text-primary" style={{ cursor: "pointer" }}>Rainmatter</span>
                    ...
                    <p>
                        And yet, we are always up to something new every day. Catch up onthe latest updates on our blog or see what the media is saying aboutus.
                    </p>
                </div>
            </div>
        </div>
